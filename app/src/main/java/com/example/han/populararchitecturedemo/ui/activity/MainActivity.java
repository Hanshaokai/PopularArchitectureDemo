...
import com.example.han.populararchitecturedemo.ui.fragment.TypeFragment;
...
import com.example.han.populararchitecturedemo.utils.ShareUtil;
import com.example.han.populararchitecturedemo.utils.SnackBarUtil;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.menu_share:
                ShareUtil.share(mContext, ResourceUtil.resTostr(mContext,
                        R.string.main_share_content));
                break;
        }
